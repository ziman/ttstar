...
(print
  (letrec* (
    ...
    (letrec* ((inputSize (rts-arg-peano 'Z 'S 0)))
      ((isJust (IsPalindrome ((genList T) inputSize))) ((isPalinV ((genList T) inputSize)) ((((((subst List) V) (((index (length ((genList T) inputSize))) ((genList T) inputSize)) ((reverse_ ((genList T) inputSize)) (((rev_ Nil) RNil) ((genList T) inputSize))))) ((genList T) inputSize)) (eq ((genList T) inputSize))) (((build (length ((genList T) inputSize))) ((genList T) inputSize)) ((reverse_ ((genList T) inputSize)) (((rev_ Nil) RNil) ((genList T) inputSize))))))))))
