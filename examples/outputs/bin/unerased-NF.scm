...
(print
  (letrec* (
                      ...
                      (letrec* ((f (lambda (_e0)
                        (match (list _e0)
                          (((_ _ _ _ hi_ hi lo_ lo pf))
                            (letrec* (
                              (x ((plus lo_) (double ((plus hi_) ((plus xn_) yn_)))))
                              (y ((plus c) ((plus ((plus xb_) (double xn_))) ((plus yb_) (double yn_)))))
                              (eq `(eq))
                            )
    ...
    (((((((add_ inputSize) Z) ((binVal True) inputSize)) ((binVal False) inputSize)) O) ((mkBin True) inputSize)) ((mkBin False) inputSize))))
