...
pruneDef (Def n R ty (Abstract Constructor) mcs)
    = [Def n () (pruneTm ty) (Abstract Constructor) noConstrs]
pruneDef (Def n R ty body mcs)
    = [Def n () (V Blank) (pruneBody body) noConstrs]
